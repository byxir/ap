    ...
    <div className="grid h-screen w-full">
      <div className="grid h-screen grid-cols-[auto_max-content] gap-12">
        <div className="grid h-screen w-full grid-rows-[repeat(2,_max-content)] gap-12 overflow-auto py-10 pl-12">
          <div className="relative grid grid-cols-[max-content_max-content_364px] justify-between gap-14">
            <div className="col-span-3 row-span-1 grid h-64 grid-cols-[256px_auto_max-content]  gap-8">
            ...
            <div className="grid h-60 w-72 grid-rows-[max-content_auto] rounded-4xl bg-accentElement shadow-md">
              <div className="w-max px-6 pt-4 pb-4 text-3xl">Socials</div>
              <div className="justify-content-center grid w-max grid-flow-col grid-rows-[repeat(2,_max-content)] gap-4 justify-self-center px-6">
                {socials.map((s) => (
                  <a
                    target="_blank"
            ...
            <div className="grid h-60 w-full grid-cols-[4fr_3fr] items-center rounded-4xl bg-accentElement shadow-md">
              <div className="grid pl-10">
                <div className="grid h-max grid-rows-2 text-3xl">
                  <div className="">Horizon</div>
                  <div className="">Main</div>
                </div>
              </div>
              <div className="grid items-center justify-items-center">
                <div className="mb-6 h-40 w-36">
                  <img src="../../../5.png" alt="" />
                </div>
              </div>
            </div>
            ...
            <div className="grid h-96 grid-flow-row auto-rows-max gap-4 overflow-auto p-2">
              {players.map((m) => (
                ...
                >
                  ...
                  <div className="grid h-full w-full grid-rows-2 items-center px-3">
